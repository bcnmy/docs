...
:::info
**Smart Account Creation**: The Smart Account is not created immediately. It will be automatically created when you do the first transaction.
:::

We create a new instance of the account using the BiconomySmartAccount class and pass it configuration. 
...
async function createTransaction() {
  ...
  const smartAccount = await createAccountConfig();
