...
Get your hands dirty by trying out the following tutorials in your environment.

### [1. Send A Simple Transaction](/tutorials/sendSimpleTransaction)
In this you will do a simple transaction which will be a user paid transaction for which your smart account should have funds to pay the gas fees for the txn.

### [2. Send A Batch of Transactions](/tutorials/sendTransactionsBatch)
...
### [3. Send A Gasless Transaction](/tutorials/sendGasless)
...
### [4. Pay gas in ERC20](/tutorials/payERC20Token)
