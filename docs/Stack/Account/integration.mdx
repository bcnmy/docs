...
To integrate a `Biconomy Smart Account`, you'll need the [bundler url](/dashboard#bundler-url). If you also want to use the paymaster, you'll need [Paymaster api key](/stack/paymaster).
...
- ECDSA Validation Module. Other validation [modules](/stack/modules) can be enabled based on the specific use case.
