...
Check out the different ways you can create a Biconomy Smart Account [here](/stack/account/signers).
...
This allows you, as a developer, to build modules that allow for session keys, multi-chain validation modules, pass keys, and more. Learn more about Modules [here](/stack/modules).
