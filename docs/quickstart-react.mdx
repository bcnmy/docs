...
npm install react react-dom viem wagmi @tanstack/react-query @biconomy/account @biconomy/use-aa
...
yarn add react react-dom viem wagmi @tanstack/react-query @biconomy/account @biconomy/use-aa
...
pnpm add react react-dom viem wagmi @tanstack/react-query @biconomy/account @biconomy/use-aa
