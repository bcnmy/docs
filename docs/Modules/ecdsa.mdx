...
| [ecdsaModuleConfig](https://bcnmy.github.io/biconomy-client-sdk/interfaces/ECDSAOwnershipValidationModuleConfig) | The configuration options expected during module initialisation                                                                       |
