...
Implementation of this is similar to the Session Key Manager module guide - a full implementation example is shown [here](/tutorials/sessions/createBatchSession)
