...
The Delegated Authorisation Network (DAN) is Biconomy’s off-chain authorization network, which leverages the economic security of Eigenlayer AVS. It is designed to enhance the security, interoperability, and speed of managing authorization keys for smart accounts and it's sessions. Read more about DAN [here](https://www.biconomy.io/post/introducing-dan-the-programmable-authorisation-network-for-ai-agents)
