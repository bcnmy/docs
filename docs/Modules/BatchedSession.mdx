...
Implementation of this is similar to the Session Key Manager module guide - a full timplementation example is shown [here](/tutorials/sessionkeys/batchedTransferWithSession)
