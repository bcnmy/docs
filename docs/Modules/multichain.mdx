...
- **Flexible Signer Authentication**: Supports various signer solutions like Dynamic, Privy, Fireblocks, Arcana Auth, Capsule, Lit protocol, Turnkey, Web3Auth, Particle, Magic, Portal, etc.
...
let baseAccount = await createSmartAccountClient({
  biconomyPaymasterApiKey: "https://legacy-docs.biconomy.io/dashboard/paymaster"
