---
sidebar_label: "Multichain Validation Module"
sidebar_position: 3
...
This module acts as an extention of the [ECDSA Module](/Modules/ecdsa). The added benefit of this module is you now have the ability to sign once and authorize any amount of userOps accross multiple blockchain networks.
...
You can send a multi-chain signature to send different userops on different chains and be validated by this module. if plain ecdsa signature(65 bytes) is sent then the module assumes it’s form as standard ECDSA validation module
...
### Integration - Importing and Initializing Multichain Validation Module 🌟
...
### Integration - Signing and Sending Multichain userops🌟
