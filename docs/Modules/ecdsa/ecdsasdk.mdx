...
:::info
The Smart Account's address is counterfactual, its address can be calculated before deployment. This generated address depends on the default validation module specified during account creation, here ECDSA Module.
:::
