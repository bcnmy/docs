...
For SessionFile storage, you need to create two files in the root folder, with smartAccountAddress_sessions.json and smartAccountAddress_signers.json names. For instance, if the account address is 0x123 then create 0x123_sessions.json and 0x123_signers.json.
