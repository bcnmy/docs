...
```
If you are facing any error in this step, make sure your smart account wallet has sufficient funds.
        ...
        params: [
          {
            ...
            paymasterAndData: "0x" // this is mandatory otherwise you get this error Cannot read properties of undefined (reading 'length')
          },
          "0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789"
        ],
    };
