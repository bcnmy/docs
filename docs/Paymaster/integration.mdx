...
To see how this interacts with other packages in the sdk you can view the [Smart Accounts Integration page](/Account/integration).
  ...
  const biconomySmartAccount = await createSmartAccountClient(
    {
      ...
      chainId: 80002
  bundlerUrl:
    "https://legacy-docs.biconomy.io/dashboard#bundler-url", // <-- Read about this here
...
```typescript
  ...
  const paymaster: IPaymaster = await createPaymaster({
    paymasterUrl: "", // <-- Read about at https://legacy-docs.biconomy.io/dashboard/paymaster
    strictMode: true
  });
