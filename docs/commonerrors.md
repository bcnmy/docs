...
| AA41 to little verificationGas | Throws if verificationGasLimit sent in userOp is not enough to be able to verify transaction signing and prefund gas amount of the transaction. |
