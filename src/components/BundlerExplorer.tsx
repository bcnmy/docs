...
export default function Explorer() {
  ...
  const opsHashMethods = ["eth_getUserOperationReceipt", "eth_getUserOperationByHash", "biconomy_getUserOperationStatus"]
  const noEditMethods = ["eth_chainId", "eth_supportedEntryPoints", "biconomy_getGasFeeValues" ]
  const fullFormMethods = ["eth_estimateUserOperationGas","eth_sendUserOperation"]
...
useEffect(() => {
  const raw = JSON.stringify(sampleRequests.eth_estimateUserOperationGas, null, 2);
  setSample(raw)
},[])
        ...
        <h2>Edit Request</h2>
            ...
            <label className="inputLabel">Method</label>
                ...
                <option value="eth_estimateUserOperationGas">eth_estimateUserOperationGas</option>
                    ...
                    <option value="biconomy_getGasFeeValues">biconomy_getGasFeeValues</option>
                    <option value="biconomy_getUserOperationStatus">biconomy_getUserOperationStatus</option>
                </select>
