...
To use the full potential of the `Biconomy Smart Account` you will need a [bundler url](/Bundler/integration) and a [paymaster api key](/paymaster). Below is a basic installation and integration for smart accounts in your code.
