...
To use the full potential of the `Biconomy Smart Account` you will need a [bundler url](/stack/bundler/integration) and a [paymaster api key](/stack/paymaster). Below is a basic installation and integration for smart accounts in your code.
